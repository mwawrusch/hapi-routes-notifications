...
(function() {
  ...
  routesToExpose = [require('./routes-notifications-notification-id-mark-as-read-post'), require('./routes-notifications-post'), require('./routes-users-user-id-notifications-get'), require('./routes-users-user-id-notifications-mark-as-read-post')];
